...
from selenium.webdriver.common.by import By #nos ayuda a hacer referencia a los elemntos de un sitio web
#a tra vez de sus selectores
from selenium.webdriver.support.ui import WebDriverWait #nos  permitira hacer uso de las exptected condictions
